  ...
  return (
    <section className="w-full max-w-[380px]">
      ...
      <Form>
        ...
        <FormField autoComplete="nickname" hint="한글, 영문, 숫자, 밑줄 2–16자" label="닉네임" maxLength={16} minLength={2} name="nickname" required />
        <FormField autoComplete="new-password" hint="8자 이상" label="비밀번호" minLength={8} name="password" required type="password" />
